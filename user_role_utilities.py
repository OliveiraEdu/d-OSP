...
def dump_to_csv(account_id, user_account_full_name, user_account_email, user_account_institution, user_account_orcid, user_role, user_private_key, user_public_key, filename="datasets/user_role_accounts.csv"):
    try:
