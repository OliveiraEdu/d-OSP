...
The Open Science paradigm seeks to promote a culture of transparency, where researchers openly share data, methods, and results, fostering collaboration across disciplines. By doing so, it aims to increase the reliability and reproducibility of research findings. The movement proposes the implementation of five interrelated principles: Open data, open analysis, open materials, pre-registration and open access \cite{van_dijk_open_2021}.

\begin{table}[ht]
    \centering
    \caption{The Five Principles of Open Science}
    ...
    \begin{tabular}{|l|p{11cm}|}
        ...
        \hline
        Open Materials     & Providing full access to the materials, tools, and instruments used in the research, such as surveys, protocols, or software.                                        \\
        \hline
        Pre-registration   & Publicly registering study designs, hypotheses, and analysis plans before data collection to prevent selective reporting and increase research integrity.            \\
        \hline
