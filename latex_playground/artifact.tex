...
\subsection*{Project Account Representation}
\begin{figure}[h]
      \centering
...
In the project representation, the \texttt{file\_1} attribute consists of two CID values:

\begin{itemize}
      \item The \textbf{first CID} (\texttt{QmTLZSqzPexwEdniZXLPN6fUfmEXX6MXS3b4QjKURgxc9y}) corresponds to the \textbf{file stored on IPFS}.
